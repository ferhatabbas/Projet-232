...
public class TestClassDinausaure {
	...
	{	
		...
		assertTrue(dinosaure2.getDinosaureID() == 1);		
	}
	...
	{		
		...
		dinosaure1.setName(name_Dino);
		assertEquals(dinosaure1.getName(),name_Dino);		
	}
	...
	{	
		...
		assertEquals(dinosaure3.getDinosaureID(),Value);	
